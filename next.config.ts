...
const nextConfig = {
  ...
  async headers() {
    ...
    const csp = [
      ...
      "frame-src 'self' https://*.clerk.accounts.dev https://*.clerk.com https://*.clerk.dev https://clerk.brandexme.com https://challenges.cloudflare.com https://www.facebook.com",
