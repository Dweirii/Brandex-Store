  ...
  return (
    <section className="relative overflow-hidden bg-white dark:bg-card">
      <div className="container relative px-4 sm:px-6 lg:px-8 py-16 sm:py-20 md:py-24 lg:py-32">
        ...
        >
          <motion.div
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#00B81A]/10 border border-[#00B81A]/20 text-xs sm:text-sm font-medium text-[#00B81A] mb-4 sm:mb-6"
